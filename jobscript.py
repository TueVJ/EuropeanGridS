...
def plot_linecaps_vs_gamma(path='./results/',prefix='homogenous_gamma_balred_quantiles',label=['needed for 50 % balancing reduction','needed for 90 % balancing reduction']):
